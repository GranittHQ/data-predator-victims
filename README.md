# Predator Victim Database

Granitt is tracking details about victims of Intellexa's Predator spyware based on publicly available information. This database is focused on individuals and small groups of people. The goal is to make the records as comprehensive as possible by collecting and sorting published reports. The database is updated regularly as more information becomes available.
